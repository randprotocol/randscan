/* @ts-self-types="./randscan_viewing.d.ts" */
 ...
 * @returns {string}
 */
export function key_info(input, kind) {
    let deferred4_0;
    let deferred4_1;
    try {
        ...
        const ret = wasm.key_info(ptr0, len0, ptr1, len1);
        var ptr3 = ret[0];
        var len3 = ret[1];
        if (ret[3]) {
            ptr3 = 0; len3 = 0;
 ...
 * @returns {string}
 */
export function nullifier_of(key_kind, key, cm_hex) {
    let deferred5_0;
    let deferred5_1;
    try {
        ...
        const len1 = WASM_VECTOR_LEN;
        const ptr2 = passStringToWasm0(cm_hex, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len2 = WASM_VECTOR_LEN;
        const ret = wasm.nullifier_of(ptr0, len0, ptr1, len1, ptr2, len2);
        var ptr4 = ret[0];
        var len4 = ret[1];
        if (ret[3]) {
            ptr4 = 0; len4 = 0;
 ...
 * @param {string} h_in_hex
 * @param {string} envelope_json
 * @param {string} key_kind
 * @param {string} key
 * @returns {string}
 */
export function open_call(h_in_hex, envelope_json, key_kind, key) {
    let deferred6_0;
    let deferred6_1;
    try {
        const ptr0 = passStringToWasm0(h_in_hex, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        ...
        const ret = wasm.open_call(ptr0, len0, ptr1, len1, ptr2, len2, ptr3, len3);
        var ptr5 = ret[0];
        var len5 = ret[1];
        if (ret[3]) {
            ptr5 = 0; len5 = 0;
 ...
 * @returns {string}
 */
export function open_note(cm_hex, envelope_json, key_kind, key) {
    let deferred6_0;
    let deferred6_1;
    try {
...
function __wbg_get_imports() {
    ...
    return {
        __proto__: null,
        "./randscan_viewing_bg.js": import0,
    };
}
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('randscan_viewing_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
